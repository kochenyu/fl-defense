...
def read_txt(column_name):
    train_pd = pd.read_csv(os.path.join(data_path, r"train/Inertial Signals", f'{column_name}_train.txt'), header=None,
                           names=[column_name])
    test_pd = pd.read_csv(os.path.join(data_path, r"test/Inertial Signals", f'{column_name}_test.txt'), header=None,
                          names=[column_name])
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--path', type=str, default=r"./data/UCI HAR Dataset", help='UCI dataset data path')
    parser.add_argument('--path', type=str, default=os.path.join("data", "UCI HAR Dataset"), help='UCI dataset '
                                                                                                       'data path')
